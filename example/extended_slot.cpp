...
int main()
{
  ...
  sig_type sig;
  {
    sig_type::extended_slot_type hello(&single_shot_slot, std::placeholders::_1, "Hello");
    sig.connect_extended(hello);
  }
  sig();  // prints "Hello"
  {
    sig_type::extended_slot_type world(&single_shot_slot, std::placeholders::_1, ", World!\n");
