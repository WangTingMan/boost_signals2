...
#include <boost_signals2/dummy_mutex.hpp>
...
void do_test_mutex()
{
    test_lock<boist::signals2::mutex>()();
// try_lock not supported on old versions of windows
    ...
    test_trylock<boist::signals2::mutex>()();
#endif
    test_lock_exclusion<boist::signals2::mutex>()();
}
...
{
    test_lock<boist::signals2::dummy_mutex>()();
    test_trylock<boist::signals2::dummy_mutex>()();
}
