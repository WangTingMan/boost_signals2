...
#ifndef BOIST_SIGNALS2_DETAIL_AUTO_BUFFER_HPP_25_02_2009
#define BOIST_SIGNALS2_DETAIL_AUTO_BUFFER_HPP_25_02_2009

#include <boost_signals2/detail/scope_guard.hpp>
...
namespace detail
{
    ...
    public:
        ...
        typedef T*                                       pointer;
        typedef pointer                                  allocator_pointer;
        ...
        typedef typename std::conditional< std::is_trivially_assignable_v<T, T>
    ...
    private:
        ...
        static void copy_rai( I begin, I end,
                              pointer where, const std::bool_constant<b>& )
        {
                                 ...
                                 const std::true_type& )
        {
            ...
            std::swap( l.members_.capacity_, r.members_.capacity_ );
        }
        ...
        {
            grow_back( n, std::is_default_constructible<T>() );
        }
        ...
        void grow_back_one()
        {
            grow_back_one( std::is_nothrow_constructible<T, T>() );
        }
    ...
    public:
        ...
        void swap( auto_buffer& r )
        {
            ...
            if( both_on_heap )
            {
                std::swap( get_allocator(), r.get_allocator() );
                std::swap( members_.capacity_, r.members_.capacity_ );
            ...
            if( exactly_one_on_stack )
            {
                ...
                std::swap( get_allocator(), r.get_allocator() );  // assume nothrow
                std::swap( members_.capacity_, r.members_.capacity_ );
                std::swap( size_, r.size_ );
    ...
    private:
        ...
        struct members_type
        {
            ...
            void* address() const
            { return reinterpret_cast<void*>(const_cast<char*>(buf)); }
        };
