/*
  boist::signals2::connection provides a handle to a signal/slot connection.
...
#ifndef BOIST_SIGNALS2_CONNECTION_HPP
#define BOIST_SIGNALS2_CONNECTION_HPP

#include <boost_signals2/detail/auto_buffer.hpp>
#include <boost_signals2/detail/null_output_iterator.hpp>
    ...
    namespace detail
    {
      ...
      public:
        garbage_collecting_lock(Mutex &m):
          lock(m)
        {}
        garbage_collecting_lock( garbage_collecting_lock const& ) = delete;
